...
export interface WeekGroupRepository {
    ...
    getWeekGroupsForUser(filter: WeekgroupGetDTO, userId: string): Promise<Weekgroup[] | dataPaginationResponse>;
    findById(id: string): Promise<Weekgroup | null>;
    findByIdForUser(id: string, userId: string): Promise<Weekgroup | null>;
